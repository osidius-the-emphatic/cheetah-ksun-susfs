...
`GPL-2.0-only`; документація README і посібник — як `CC-BY-4.0`. Вихідні тексти
Google, KernelSU-Next і SuSFS отримуються окремо та зберігають
...
[посібнику українською](guide.uk.md).
